 <div class="dashboard-nav bg-white flx-between gap-md-3 gap-2">
     <div class="dashboard-nav__left flx-align gap-md-3 gap-2">
         ...
         <form action="#" class="search-input d-sm-block d-none">
             <span class="icon">
                 <img src="{{ asset('build/assets/frontend/assets/images/icons/search-dark.svg') }}" alt="" class="white-version">
                 <img src="{{ asset('build/assets/frontend/assets/images/icons/search-dark-white.svg') }}" alt="" class="dark-version">
             </span>
                     ...
                     <ul class="user-profile-dropdown">
                         <li class="sidebar-list__item">
                             <a href="dashboard-profile.html" class="sidebar-list__link">
                                 <span class="sidebar-list__icon">
                                     <img src="{{ asset('build/assets/frontend/assets/images/icons/sidebar-icon2.svg') }}" alt="" class="icon">
                                     <img src="{{ asset('build/assets/frontend/assets/images/icons/sidebar-icon-active2.svg') }}" alt=""
                         ...
                         <li class="sidebar-list__item">
                             <a href="setting.html" class="sidebar-list__link">
                                 <span class="sidebar-list__icon">
                                     <img src="{{ asset('build/assets/frontend/assets/images/icons/sidebar-icon10.svg') }}" alt="" class="icon">
                                     <img src="{{ asset('build/assets/frontend/assets/images/icons/sidebar-icon-active10.svg') }}" alt=""
                                         class="icon icon-active">
                                 </span>
