...
<body>
    ...
    <div class="mobile-menu d-lg-none d-block">
        ...
        <div class="mobile-menu__inner">
            <a href="index.html" class="mobile-menu__logo">
                <img src="{{ asset('build/assets/frontend/assets/images/logo/logo-two.png') }}" alt="Logo" class="white-version">
            </a>
    ...
    <section class="dashboard">
        <div class="dashboard__inner d-flex">
           ...
           @include('auth.frontend.dashboard.layout.sidebar')
            <!-- ===================== Dashboard Sidebar End ======================= -->

            <div class="dashboard-body">

                <!-- Dashboard Nav Start -->
               @include('auth.frontend.dashboard.layout.navbar')
                <!-- Dashboard Nav End -->
              ...
              @include('auth.frontend.dashboard.layout.footer')
