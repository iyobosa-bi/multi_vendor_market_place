 <footer class="footer-section" style="background: url({{ asset('build/assets/frontend/assets/images/shapes/footer-bg.png') }});">
            <div class="container">
                <div class="subscription pt_55 pb_45" style="background: url({{ asset('build/assets/frontend/assets/images/thumbs/subscrib_bg.jpg') }});">
                ...
                <div class="row gy-5">
                    <div class="col-xl-3 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-widget__logo">
                                <a href="index.html"> <img src="{{ asset('build/assets/frontend/assets/images/logo/white-logo-two.png') }}" alt=""></a>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="footer_widget_count">
                            ...
                            <div class="img">
                                <img src="{{ asset('build/assets/frontend/assets/images/thumbs/pay_brand.png') }}" alt="Payment" class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
                </div>
